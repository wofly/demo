...
export default {
    ...
    async getDataListHW(productId,solutionId, templateId, machineId) {
        ...
        const SQL = `SELECT
                ...
                info.withdraw_date,
                detail.is_expansion,
                detail.powerline_type,
                detail.expansion_mode_id
                FROM
...
//==========================================数据源准备：从json数据源中获取的数据========================================start
        ...
        for (let i = dataListSW.length - 1; i >= 0; i--) {
            ...
            if (dataListSW[i].category_id == 33 || dataListSW[i].category_id == 34) {
                let obj = {
                    ...
                    'expansion_mode_id':dataListSW[i].expansion_mode_id
                };
                hpoList.push(obj);
                dataListSW.splice(i, 1);
            }
        ...
        for (let j = 0; j < relatedList.length; j++) {
            let obj = {
                ...
                'expansion_mode_id':relatedList[j].expansion_mode_id
            };
            //逻辑分区
                ...
                if (headerSWMA[m].Classify == swmaList[o].Classify) {
                    ...
                    for (let k = 0; k < thirdSWMA.length; k++) {
                        ...
                        if (swmaList[o].id == thirdSWMA[k].choice_software_id) {
                            ...
                            this.setValueInJsonByKey(machinePropertySWMA2, 'QUANTITY', this.appendToString(thirdSWMA[k].component_count));
                            ...
                            this.setValueInJsonByKey(machinePropertySWMA2, 'ADDITION FLAG',swmaList[o].addition_flag);
